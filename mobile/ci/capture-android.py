...
(out/'capture.json').write_text(json.dumps({'source':os.environ.get('GITHUB_SHA','local'),'platform':'Android','stages':[1,6,9],'method':'Native GLES screen recording; debug bot selects actual color inputs.'},indent=2)+'\n')
